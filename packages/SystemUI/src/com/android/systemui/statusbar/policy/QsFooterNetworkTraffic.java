...
*
*/
public class QsFooterNetworkTraffic extends TextView implements StatusIconDisplayable {
     ...
     *  @hide
     */
    public QsFooterNetworkTraffic(Context context) {
        this(context, null);
    }
     ...
     *  @hide
     */
    public QsFooterNetworkTraffic(Context context, AttributeSet attrs) {

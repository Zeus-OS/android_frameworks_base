...
package com.android.systemui.zenx.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.zenx.header.STATUS_BAR_HEADER_UPDATE";

 ...
 */
public class VolumeDialogImplAOSPA implements VolumeDialog,
        ConfigurationController.ConfigurationListener, LocalMediaManager.DeviceCallback, Iota.ThemeUpdater {
    private static final String TAG = Util.logTag(VolumeDialogImplAOSPA.class);
    ...
    public VolumeDialogImplAOSPA(Context context) {
        mContext =
                new ContextThemeWrapper(context, R.style.qs_theme);
        mIota = Dependency.get(Iota.class);
        ...
        mElevation = mContext.getResources().getDimension(R.dimen.volume_dialog_aosp_elevation);
        mSpacer = mContext.getResources().getDimension(R.dimen.volume_dialog_aospa_row_spacer);
        ...
        mHandler.postDelayed(() -> {
            if (mLocalMediaManager == null) {
                ...
                mLocalMediaManager.registerCallback(VolumeDialogImplAOSPA.this);
            }
        }, 3000);
    }
    ...
    private void initDialog() {
        ...
        lp.setTitle(VolumeDialogImplAOSPA.class.getSimpleName());
        ...
        mDialogView = mDialog.findViewById(R.id.volume_dialog_aospa);
    ...
    @Override
    public void updateVolumeThemes() {
        mIota.hideThings(mRinger, mExpandRowsView, null);
    }
    ...
    private void cleanExpandedRows() {
        ...
        float width = mContext.getResources().getDimension(
                R.dimen.volume_dialog_aospa_panel_width) + mSpacer;
        float z = mElevation;
    ...
    public void dump(PrintWriter writer) {
        writer.println(VolumeDialogImplAOSPA.class.getSimpleName() + " state:");
    ...
    private void initRow(final VolumeRow row, final int stream, int iconRes, int iconMuteRes,
        ...
        row.view = mDialog.getLayoutInflater().inflate(R.layout.volume_dialog_row_aospa,

 ...
 */
public class VolumeDialogImplAOSPRounded implements VolumeDialog,
        ConfigurationController.ConfigurationListener, OnLongClickListener, Iota.ThemeUpdater {
    private static final String TAG = Util.logTag(VolumeDialogImplAOSPRounded.class);
    ...
    public VolumeDialogImplAOSPRounded(Context context) {
        mContext =
    ...
    private void initDialog() {
        ...
        lp.setTitle(VolumeDialogImplAOSPRounded.class.getSimpleName());
    ...
    public void updateVolumeThemes() {
        mIota.setPaddingLocation(mWindow, null, mDialogView);
    ...
    public void dump(PrintWriter writer) {
        writer.println(VolumeDialogImplAOSPRounded.class.getSimpleName() + " state:");

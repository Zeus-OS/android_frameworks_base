...
package com.android.systemui.zeus.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.zeus.header.STATUS_BAR_HEADER_UPDATE";

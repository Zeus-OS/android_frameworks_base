...
package com.android.systemui.zeus.carrierlabel;
...
import com.android.systemui.zeus.carrierlabel.SpnOverride;
...
public class CarrierLabel extends TextView implements DarkReceiver {
    ...
    public CarrierLabel(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (ZeusUtils.hasNotch(mContext)) {
    ...
    private final BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TelephonyManager.ACTION_SERVICE_PROVIDERS_UPDATED.equals(action)
                ...
                isCN = ZeusUtils.isChineseLanguage();
            }
        }
    };

 ...
 */
public class SunsetClockController implements ClockPlugin {
     ...
     */
    public SunsetClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mBigClockView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.sunset_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_sunset);
    }

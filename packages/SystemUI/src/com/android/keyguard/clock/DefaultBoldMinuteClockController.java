 ...
 */
public class DefaultBoldMinuteClockController implements ClockPlugin {
     ...
     */
    public DefaultBoldMinuteClockController(Resources res, LayoutInflater inflater,
    ...
    public String getName() {
        return "default_bold_minute";
    }

    @Override
    public String getTitle() {
        return mResources.getString(R.string.clock_title_default_minute_bold);
    }
    ...
    public Bitmap getPreview(int width, int height) {
        ...
        previewTime.setFormat12Hour(Html.fromHtml("h:<strong>mm</strong>"));
        previewTime.setFormat24Hour(Html.fromHtml("kk:<strong>mm</strong>"));

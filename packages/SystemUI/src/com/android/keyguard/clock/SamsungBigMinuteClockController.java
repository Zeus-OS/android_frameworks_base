 ...
 */
public class SamsungBigHourClockController implements ClockPlugin {
     ...
     */
    public SamsungBigHourClockController(Resources res, LayoutInflater inflater,
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_samsung_big_hours);
    }
    ...
    public Bitmap getPreview(int width, int height) {
        ...
        previewTime.setFormat12Hour(Html.fromHtml("<big>hh</big><br>mm"));
        previewTime.setFormat24Hour(Html.fromHtml("<big>kk</big><br>mm"));

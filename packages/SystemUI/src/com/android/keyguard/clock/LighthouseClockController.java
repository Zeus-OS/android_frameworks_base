 ...
 */
public class LighthouseClockController implements ClockPlugin {
     ...
     */
    public LighthouseClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mBigClockView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.lighthouse_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_lighthouse);
    }

    @Override
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.lighthouse_preview);
    }

 ...
 */
public class BirdClockController implements ClockPlugin {
     ...
     */
    public BirdClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mBigClockView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.bird_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_bird);
    }

    @Override
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.bird_preview);
    }

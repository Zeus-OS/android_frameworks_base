 ...
 */
public class MountainCircleController implements ClockPlugin {
     ...
     */
    public MountainCircleController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mBigClockView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.mountain_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_mountain);
    }

    @Override
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.mountain_preview);
    }

 ...
 */
public class CloudyClockController implements ClockPlugin {
     ...
     */
    public CloudyClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mBigClockView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.cloudy_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_cloudy);
    }

    @Override
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.cloudy_preview);
    }

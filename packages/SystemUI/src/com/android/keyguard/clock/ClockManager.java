...
public final class ClockManager {
    ...
    ClockManager(Context context, InjectionInflationController injectionInflater,
        ...
        addBuiltinClock(() -> new ZenxClockController(res, layoutInflater, colorExtractor, context));
        ...
        addBuiltinClock(() -> new CloudyClockController(res, layoutInflater, colorExtractor, context));
        ...
        addBuiltinClock(() -> new CityCircleController(res, layoutInflater, colorExtractor, context));
        addBuiltinClock(() -> new MountainCircleController(res, layoutInflater, colorExtractor, context));
        ...
        addBuiltinClock(() -> new AltDividedLinesClockController(res, layoutInflater, colorExtractor, context));
        addBuiltinClock(() -> new MNMLBoxClockController(res, layoutInflater, colorExtractor, context));
        addBuiltinClock(() -> new XMNMLBoxClockController(res, layoutInflater, colorExtractor, context));
        addBuiltinClock(() -> new XtndMNMLBoxClockController(res, layoutInflater, colorExtractor, context));

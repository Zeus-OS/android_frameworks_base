 ...
 */
public class LonelyWolfClockController implements ClockPlugin {
     ...
     */
    public LonelyWolfClockController(Resources res, LayoutInflater inflater,
    ...
    private void createViews() {
        mBigClockView = (ClockLayout) mLayoutInflater
                .inflate(R.layout.lonely_wolf_animation, null);
    ...
    public String getTitle() {
        return mResources.getString(R.string.clock_title_lonely_wolf);
    }

    @Override
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(mResources, R.drawable.lonely_wolf_preview);
    }

...
public abstract class BiometricServiceBase extends SystemService
    ...
    public BiometricServiceBase(Context context) {
        ...
        mCleanupUnusedFingerprints = statsModality() == BiometricsProtoEnums.MODALITY_FINGERPRINT && mContext.getResources().getBoolean(
                        org.lineageos.platform.internal.R.bool.config_cleanupUnusedFingerprints);
        mPostResetRunnableForAllClients = statsModality() == BiometricsProtoEnums.MODALITY_FINGERPRINT && mContext.getResources().getBoolean(
